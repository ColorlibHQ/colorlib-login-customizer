...
class Colorlib_Login_Customizer_CSS_Customization {
	...
	public function generate_css() {
        ...
        $responsive_css = '@media all and (max-width:760px){.ml-half-screen.ml-login-align-3 .ml-container .ml-form-container, .ml-half-screen.ml-login-align-1 .ml-container .ml-extra-div,.ml-half-screen.ml-login-align-3 .ml-container .ml-extra-div, .ml-half-screen.ml-login-align-1 .ml-container .ml-form-container {width:100%;}}';
        ...
        echo '<style type="text/css" id="clc-responsive-css">' . $responsive_css . '</style>';
	}
