...
class Colorlib_Login_Customizer_CSS_Customization {
	...
	public function generate_css() {
		...
		$logo_css = '.login.clc-both-logo h1 a{width:100%;height:100%;text-indent: unset;background-position:top center !important;padding-top:'. (30 + $this->options['logo-height']) .'px; background-size: '. $this->options['logo-width'] . 'px ' . $this->options['logo-height'] .'px; margin-top: -'.(70 + $this->options['logo-height']).'px; position:relative;}';
