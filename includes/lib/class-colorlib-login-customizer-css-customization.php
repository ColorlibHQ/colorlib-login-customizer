...
class Colorlib_Login_Customizer_CSS_Customization {
	...
	public function generate_css() {
		...
		$logo_css = '.login.clc-both-logo h1 a{width:100%;height:100%;text-indent: unset;background-position:top center !important;padding-top:' . (30 + absint( $this->options['logo-height'] )) . 'px; background-size: ' . $backgriund_size . '; margin-top: -' . (30 + absint( $this->options['logo-height'] )) . 'px; position:relative;background-image:url(' . get_site_url() . '/wp-admin/images/wordpress-logo.svg)}';
