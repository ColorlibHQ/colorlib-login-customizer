...
class Colorlib_Login_Customizer_CSS_Customization {
	...
	public function generate_css() {
		...
		echo '<style type="text/css" id="clc-style">' . esc_html( $css ) . '</style>';
		echo '<style type="text/css" id="clc-columns-style">' . sc_html( $columns_css ) . '</style>';
		echo '<style type="text/css" id="clc-logo-style">' . sc_html( $logo_css ) . '</style>';
		echo '<style type="text/css" id="clc-custom-css">' . sc_html( $custom_css ) . '</style>';
